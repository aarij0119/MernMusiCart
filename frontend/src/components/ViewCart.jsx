                ...
                <div className='flex flex-wrap gap-4 border-t-1 mt-4 pt-4'>
                    {
                        Cart.map((items,idx)=>{
                            ...
                            <div className='flex flex-col gap-2'>
                                <h1 className='text-2xl font-bold'>{items.Itemname}</h1>
                                <h2 className='text-lg font-semibold'>Price - ₹{items.ItemsPrice}</h2>
                                <h2 className='text-lg font-semibold'>Colour : {items.ItemDescription}</h2>
